...
public class TokenController {
	...
	public void getTokens(OAuth2Authentication auth, HttpServletRequest request) {
		...
		OAuth2AccessToken accessToken = (OAuth2AccessToken) tokenStore.readAccessToken(details.getTokenValue());

		if (null != tokenStore.readAccessToken(details.getTokenValue())) {
			OAuth2RefreshToken oAuth2RefreshToken = (OAuth2RefreshToken) tokenStore
